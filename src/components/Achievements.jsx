...
const AchievementCard = ({ achievement, index }) => (
  <motion.div
    ...
    className="relative bg-dark-card border border-dark-border rounded-2xl p-8 text-center hover:border-accent/30 transition-all duration-500 group"
  >
    <div className="text-5xl md:text-6xl font-bold text-gradient mb-3 font-mono">
    ...
    <div className="absolute top-4 right-4 text-7xl font-bold text-white/[0.02] font-mono select-none">
      {achievement.number}
    </div>
  </motion.div>
)
